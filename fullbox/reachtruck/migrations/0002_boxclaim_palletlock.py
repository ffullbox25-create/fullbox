...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="boxclaim",
            index=models.Index(fields=["agency", "status", "box_code"], name="reachtruck__agency__61a8d9_idx"),
        ),
        migrations.AddIndex(
            model_name="boxclaim",
            index=models.Index(fields=["agency", "status", "pallet_code"], name="reachtruck__agency__1399e5_idx"),
        ),
        migrations.AddIndex(
            model_name="boxclaim",
            index=models.Index(fields=["move_task", "status"], name="reachtruck__move_ta_3b310e_idx"),
        ),
        migrations.AddIndex(
            model_name="boxclaim",
            index=models.Index(fields=["shipping_order_id", "status"], name="reachtruck__shippin_dde26c_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["agency", "status", "pallet_code"], name="reachtruck__agency__715fd2_idx"),
        ),
        migrations.AddIndex(
            model_name="palletlock",
            index=models.Index(fields=["move_task", "status"], name="reachtruck__move_ta_fa7db5_idx"),
        ),
        migrations.AddConstraint(
            model_name="palletlock",
            constraint=models.UniqueConstraint(
